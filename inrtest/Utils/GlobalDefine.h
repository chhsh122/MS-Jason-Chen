...
#define SIZE_TextTitleMini                      13.0f
#define SIZE_TextTitleNormal                    17.0f
#define SIZE_TextLarge                          14.0f
#define SIZE_TextHuge                           18.0f

#define Isiphone5Before                         ([UIScreen mainScreen].bounds.size.width>320 ? YES : NO)
#define Isiphone6plus                           ([UIScreen mainScreen].bounds.size.width>400 ? YES : NO)
#define SIZE_TextNumOfButtom                    (Isiphone5Before ? SIZE_TextContentNormal:(Isiphone6plus?SIZE_TextLarge:SIZE_TextTitleMini))
